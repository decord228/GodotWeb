...
/** @type {string} */
const CACHE_VERSION = '1759697302|15177670840';
/** @type {string} */
const CACHE_PREFIX = 'DiscordWeb-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'discordweb.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["discordweb.html","discordweb.js","discordweb.offline.html","discordweb.icon.png","discordweb.apple-touch-icon.png","discordweb.audio.worklet.js","discordweb.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["discordweb.wasm","discordweb.pck","discordweb.side.wasm"];
